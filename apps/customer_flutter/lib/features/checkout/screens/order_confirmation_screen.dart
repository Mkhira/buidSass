      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.sm),
            _copyRow(context, l10n.orderConfirmationBankReference,
                details.reference),
            _copyRow(context, l10n.orderConfirmationBankIban, details.iban),
            _copyRow(context, l10n.orderConfirmationBankAmount, details.amount),
          ],
        ),
      ),
    );

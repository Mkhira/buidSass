...
public static class Endpoint
{
        ...
        CancellationToken ct)
    {
        ...
        // B2B gate: account must have a pricing.account_b2b_tiers row (Principle 9).
        ...
        var resolved = await resolver.ResolveOrCreateAsync(db, accountId, suppliedToken: null, request.MarketCode, nowUtc, ct);
        ...
        if (metadata is null)
        {
            metadata = new CartB2BMetadata { CartId = cart.Id };

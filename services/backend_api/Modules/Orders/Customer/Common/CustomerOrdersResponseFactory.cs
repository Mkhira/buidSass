...
namespace BackendApi.Modules.Orders.Customer.Common;

public static class CustomerOrdersResponseFactory
{
        ...
        IDictionary<string, object?>? extensions = null)
    {
        var problem = new ProblemDetails
        {
            ...
            Title = title,
            Detail = detail,
            Type = $"https://errors.dental-commerce/orders/{reasonCode}",

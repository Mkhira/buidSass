...
namespace BackendApi.Modules.TaxInvoices.Customer.Common;

public static class CustomerInvoiceResponseFactory
{
    public static IResult Problem(HttpContext context, int statusCode, string reasonCode,
        string title, string detail, IDictionary<string, object?>? extensions = null)
    {
        var problem = new ProblemDetails
        {
            ...
            Title = title,
            Detail = detail,
            Type = $"https://errors.dental-commerce/invoices/{reasonCode}",

...
public static class CartAdminAuthHelper
{
        ...
        string roleCode = "cart.operator")
    {
        ...
        var email = $"cart-admin-{Guid.NewGuid():N}@example.test";
        ...
        var account = new Account
        {
            ...
            EmailDisplay = email,
            PasswordHash = hasher.HashPassword("CartTests!123", SurfaceKind.Admin),
        ...
        httpContext.Request.Headers.UserAgent = "cart-tests";

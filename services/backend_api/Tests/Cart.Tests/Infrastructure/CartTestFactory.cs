...
public sealed class CartTestFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    {
        // Invalidate pricing caches so a test's seeded tax rate survives the truncation that follows.

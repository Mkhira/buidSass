...
public static class CheckoutAdminAuthHelper
{
        ...
        string roleCode = "checkout.operator")
    {
        ...
        var email = $"checkout-admin-{Guid.NewGuid():N}@example.test";
        var account = new Account
        {
            ...
            EmailDisplay = email,
            PasswordHash = hasher.HashPassword("CheckoutTests!123", SurfaceKind.Admin),
        ...
        httpContext.Request.Headers.UserAgent = "checkout-tests";

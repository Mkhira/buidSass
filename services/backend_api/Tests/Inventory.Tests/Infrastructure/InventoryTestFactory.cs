...
public sealed class InventoryTestFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, cfg) =>
        {
            cfg.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Inventory:ReservationReleaseWorkerIntervalSeconds"] = "1",
                ["Inventory:ExpiryWriteoffWorkerIntervalSeconds"] = "1",

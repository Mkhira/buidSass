...
public static class OrdersAdminAuthHelper
{
        ...
        string roleCode = "orders.operator")
    {
        ...
        var email = $"orders-admin-{Guid.NewGuid():N}@example.test";
        var account = new Account
        {
            ...
            EmailDisplay = email,
            PasswordHash = hasher.HashPassword("OrdersTests!123", SurfaceKind.Admin),
        ...
        httpContext.Request.Headers.UserAgent = "orders-tests";

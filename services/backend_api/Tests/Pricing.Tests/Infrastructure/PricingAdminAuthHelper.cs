...
public static class PricingAdminAuthHelper
{
        ...
        string roleCode = "platform.support")
    {
        ...
        var email = $"pricing-admin-{Guid.NewGuid():N}@example.test";
        ...
        var account = new Account
        {
            ...
            EmailDisplay = email,
            PasswordHash = hasher.HashPassword("PricingTests!123", SurfaceKind.Admin),
        ...
        httpContext.Request.Headers.UserAgent = "pricing-tests";

...
- [ ] T071 [P] [US2] Create `Modules/Support/Agent/GetTicketAdminDetail/GetTicketAdminDetailQuery.cs` + handler returning full thread (incl. internal notes for support roles), full assignment history, full audit history, linked-entity preview via the appropriate `IXxxLinkedReadContract`
